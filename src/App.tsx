          ...
          <div className="flex gap-x-[25px]">
            <div className=" w-[448px] h-[351px] bg-[#fadcd9] rounded-2xl px-6 py-8 flex flex-col justify-between">
              ...
              <div className="text-[20px] font-light">
                ...
                cutting-edge technology with creative expression . Based in LA,
                she crafts unique digital art experiences accesible globally
              </div>
            </div>
            ...
            <div className="w-[448px] h-[351px] bg-[#f8afa6] rounded-2xl  px-6 py-8 flex flex-col justify-between">
              ...
              <div className="text-[55px] font-medium .header_label">Contact me</div>
            </div>
          </div>
        </div>
        <div>
